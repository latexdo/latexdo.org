...
export const publicSceneControls: Array<{ scene: DemoScene; label: string; stage: DemoStage }> = [
...
export const mainSourceCompilerError = mainSourceAccepted.replace(
  "\\includegraphics{figures/results.pdf}",
  "\\includegraphics{results.pdf}",
);

export const mainSourceRevised = mainSourceAccepted.replace(
  "Our method significantly improves performance over the baseline.",
  "Our method improves accuracy from 81.4% to 87.9% over the baseline.",
);

export const demoFileSources: Record<string, string> = {
...
const reviewerTwo: HumanIdentity = {
  kind: "human",
  name: "Reviewer 2",
  role: "external reviewer",
};

export const claimAnchor: TextAnchor = {
  filePath: "main.tex",
  range: {
    startLine: 42,
    startColumn: 12,
...
export const figureAnchor: TextAnchor = {
  filePath: "main.tex",
  range: {
    startLine: 84,
    startColumn: 3,
...
export const reviewProposal: EditProposal = {
...
export const compilerFixProposal: EditProposal = {
...
export const reviewThreadsBase: ReviewThread[] = [
  {
...
export const compilerDiagnostic: Finding = {
...
export const rebuttalItem: RebuttalItem = {
  ...
  authorResponse:
    "Thank you for pointing this out. We revised Section 3 to report the exact improvement over the baseline.",
  manuscriptChange: {
    before: "significantly improves performance",
    after: "improves accuracy from 81.4% to 87.9%",
    anchor: claimAnchor,
...
export const paperReviewResult: PaperReviewResult = {
...
export const submissionReport: SubmissionReport = {
...
export const sceneCapabilities: Record<DemoScene, string[]> = {
